# -*- coding: utf-8 -*-
#
# Mopidy-Podcast documentation build configuration file, created by
# sphinx-quickstart on Fri Mar 21 06:11:33 2014.
#
...
htmlhelp_basename = 'Mopidy-Podcastdoc'
...
latex_documents = [
  ('index', 'Mopidy-Podcast.tex', u'Mopidy-Podcast Documentation',
...
man_pages = [
    ('index', 'mopidy-podcast', u'Mopidy-Podcast Documentation',
     [u'Thomas Kemmer'], 1)
]
...
texinfo_documents = [
  ('index', 'Mopidy-Podcast', u'Mopidy-Podcast Documentation',
   u'Thomas Kemmer', 'Mopidy-Podcast', 'Mopidy extension for searching and streaming podcasts.',
   'Miscellaneous'),
]
